...
- (GMYHotSpotView *)hotspotView1{
    if(!_hotspotView1){
        _hotspotView1 = [[GMYHotSpotView alloc] initWithFrame:CGRectMake(5, self.hotspotView.bottom + 20, self.view.frame.size.width - 10, self.view.frame.size.height/2) hotspotViewLayout:[GMYHotSpotViewBetterLayout new]];
    }
